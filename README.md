...
- 🔍 **零件识别**: 自动识别8种机械零件类型
- 📊 **特征提取**: 95维深度特征向量
- 🔄 **格式转换**: 支持DXF、STEP、IGES、STL、OBJ、PLY、XYZ等多种格式
- 🎯 **相似度分析**: 几何+语义双重分析 (支持 Top-K、材料/复杂度过滤、向量管理)
- 📈 **质量评估**: 图纸质量自动评分
- 🏭 **工艺推荐**: 智能加工工艺建议
- 💰 **成本估算**: 材料+加工+设置+管理费自动计算，含乐观/悲观区间
- 🤖 **AI Copilot**: 9个工具的LLM智能助手，支持思维链推理和Function Calling
- 📐 **图纸Diff**: 两版图纸几何/标注差异检测 + ECN自动生成
- 🧠 **知识图谱**: 44节点163边的制造业知识图，多跳推理
- 🔬 **3D点云分析**: PointNet架构，STL/OBJ/PLY/XYZ分类和特征提取
- 🎯 **智能异常检测**: Isolation Forest + 5种自动修复规则
- 📚 **领域嵌入**: 252+制造业同义词对微调的语义检索
- 🔄 **反馈闭环**: 用户纠正自动驱动模型权重自适应
