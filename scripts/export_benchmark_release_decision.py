...
def _knowledge_domain_release_readiness_action_plan_component(
    payload: Dict[str, Any],
) -> Dict[str, Any]:
    return (
        payload.get("knowledge_domain_release_readiness_action_plan")
        or payload
        or {}
    )
...
def _component_statuses(
    ...
    knowledge_domain_release_readiness_action_plan_component = (
        _knowledge_domain_release_readiness_action_plan_component(
            benchmark_knowledge_domain_release_readiness_action_plan
        )
    )
    ...
    return {
        ...
        "knowledge_domain_api_surface_matrix": str(
            ...
            or bundle_components.get("knowledge_domain_api_surface_matrix")
            or knowledge_domain_api_surface_matrix_component.get("status")
            or (scorecard_components.get("knowledge_domain_api_surface_matrix") or {}).get(
                "status"
            )
            or "unknown"
        ),
        "knowledge_domain_surface_matrix": str(
            ...
            or bundle_components.get("knowledge_domain_surface_matrix")
        ...
        "knowledge_domain_surface_action_plan": str(
            ...
            or bundle_components.get("knowledge_domain_surface_action_plan")
        ...
        "knowledge_domain_capability_drift": str(
            ...
            or bundle_components.get("knowledge_domain_capability_drift")
        ...
        "knowledge_domain_release_readiness_action_plan": str(
            ...
            or bundle_components.get("knowledge_domain_release_readiness_action_plan")
        ...
        "knowledge_domain_release_gate": str(
            ...
            or bundle_components.get("knowledge_domain_release_gate")
...
def _knowledge_domain_capability_drift_review_signals(
    benchmark_knowledge_domain_capability_drift: Dict[str, Any],
    component_statuses: Dict[str, str],
) -> List[str]:
    status = str(
        component_statuses.get("knowledge_domain_capability_drift") or ""
    ).strip()
...
def _knowledge_domain_surface_action_plan_review_signals(
    benchmark_knowledge_domain_surface_action_plan: Dict[str, Any],
    component_statuses: Dict[str, str],
) -> List[str]:
    status = str(
        component_statuses.get("knowledge_domain_surface_action_plan") or ""
    ).strip()
    if status in {"knowledge_domain_surface_action_plan_ready", "unknown", ""}:
        return []
    return _compact(
...
def _knowledge_domain_release_gate_review_signals(
    benchmark_knowledge_domain_release_gate: Dict[str, Any],
    component_statuses: Dict[str, str],
) -> List[str]:
    status = str(component_statuses.get("knowledge_domain_release_gate") or "").strip()
    if status in {"knowledge_domain_release_gate_ready", "unknown", ""}:
        return []
    return _compact(
...
def build_release_decision(
    *,
    ...
    knowledge_domain_release_readiness_action_plan_actions = list(
        knowledge_domain_release_readiness_action_plan_component.get("actions") or []
    )
    knowledge_domain_release_readiness_action_plan_priority_domains = list(
        knowledge_domain_release_readiness_action_plan_component.get(
            "priority_domains"
        )
        or []
    )
    ...
    review_signals.extend(
        item
        for item in _knowledge_domain_surface_action_plan_review_signals(
            benchmark_knowledge_domain_surface_action_plan,
            component_statuses,
        )
        if item not in review_signals
    ...
    if knowledge_domain_api_surface_matrix_component.get("status") not in {
        "",
        "unknown",
        "knowledge_domain_api_surface_matrix_ready",
    }:
        review_signals.extend(
            item
            for item in knowledge_domain_api_surface_matrix_recommendations
            if item not in review_signals
        )
    if knowledge_domain_surface_matrix_component.get("status") not in {
        "",
        "unknown",
        ...
        review_signals.extend(
            item
            for item in knowledge_domain_surface_matrix_recommendations
            if item not in review_signals
        )
    review_signals.extend(
        item
        for item in _knowledge_domain_capability_drift_review_signals(
            benchmark_knowledge_domain_capability_drift,
            component_statuses,
        )
        if item not in review_signals
    ...
    review_signals.extend(
        item
        for item in _knowledge_domain_release_gate_review_signals(
            benchmark_knowledge_domain_release_gate,
            component_statuses,
        )
        if item not in review_signals
    ...
    return {
        ...
        "knowledge_domain_release_readiness_action_plan_status": (
            knowledge_domain_release_readiness_action_plan_component.get("status")
            or "unknown"
        ),
        "knowledge_domain_release_readiness_action_plan": (
            knowledge_domain_release_readiness_action_plan_component
        ...
        "knowledge_domain_release_readiness_action_plan_gate_open": bool(
            knowledge_domain_release_readiness_action_plan_component.get("gate_open")
        ),
...
def render_markdown(payload: Dict[str, Any]) -> str:
    ...
    gate_recommendations = payload.get("knowledge_domain_release_gate_recommendations") or []
    ...
    lines.append(
        "- `status`: "
        f"`{payload.get('knowledge_domain_release_readiness_action_plan_status') or 'unknown'}`"
    )
    readiness_total = (
        payload.get("knowledge_domain_release_readiness_action_plan_total_action_count")
        or 0
    )
    readiness_high = (
        payload.get(
    ...
    lines.append(
        "- `counts`: "
        f"total=`{readiness_total}` "
        f"high=`{readiness_high}` "
        f"medium=`{readiness_medium}`"
    )
    lines.append(
        "- `gate_open`: "
        + str(
    ...
    readiness_actions = (
        payload.get("knowledge_domain_release_readiness_action_plan_actions") or []
    )
...
def main() -> None:
    ...
    parser.add_argument(
        "--benchmark-knowledge-domain-release-readiness-action-plan", default=""
    )
