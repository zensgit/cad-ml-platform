...
def build_summary(log_text: str, title: str) -> str:
    ...
    no_regression = "No pydantic v2 compatibility regressions detected." in log_text
...
def main() -> int:
    parser = argparse.ArgumentParser(
        description="Summarize pydantic v2 audit log into markdown table."
    )
