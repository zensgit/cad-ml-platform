...
mapping = {"WF_INPUT_BENCHMARK_RELEASE_DECISION_ENABLE": ["inputs", "benchmark_release_decision_enable"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_SCORECARD_JSON": ["inputs", "benchmark_release_decision_scorecard_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_OPERATIONAL_SUMMARY_JSON": ["inputs", "benchmark_release_decision_operational_summary_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_ARTIFACT_BUNDLE_JSON": ["inputs", "benchmark_release_decision_artifact_bundle_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_COMPANION_SUMMARY_JSON": ["inputs", "benchmark_release_decision_companion_summary_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_ENGINEERING_SIGNALS_JSON": ["inputs", "benchmark_release_decision_engineering_signals_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_REALDATA_SIGNALS_JSON": ["inputs", "benchmark_release_decision_realdata_signals_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_REALDATA_SCORECARD_JSON": ["inputs", "benchmark_release_decision_realdata_scorecard_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_OPERATOR_ADOPTION_JSON": ["inputs", "benchmark_release_decision_operator_adoption_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_READINESS_JSON": ["inputs", "benchmark_release_decision_knowledge_readiness_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DRIFT_JSON": ["inputs", "benchmark_release_decision_knowledge_drift_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_APPLICATION_JSON": ["inputs", "benchmark_release_decision_knowledge_application_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_REALDATA_CORRELATION_JSON": ["inputs", "benchmark_release_decision_knowledge_realdata_correlation_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_MATRIX_JSON": ["inputs", "benchmark_release_decision_knowledge_domain_matrix_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_CAPABILITY_MATRIX_JSON": ["inputs", "benchmark_release_decision_knowledge_domain_capability_matrix_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_CAPABILITY_DRIFT_JSON": ["inputs", "benchmark_release_decision_knowledge_domain_capability_drift_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_CONTROL_PLANE_DRIFT_JSON": ["inputs", "benchmark_release_decision_knowledge_domain_control_plane_drift_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_RELEASE_GATE_JSON": ["inputs", "benchmark_release_decision_knowledge_domain_release_gate_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_REFERENCE_INVENTORY_JSON": ["inputs", "benchmark_release_decision_knowledge_reference_inventory_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_ACTION_PLAN_JSON": ["inputs", "benchmark_release_decision_knowledge_domain_action_plan_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_SOURCE_COVERAGE_JSON": ["inputs", "benchmark_release_decision_knowledge_source_coverage_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_SOURCE_ACTION_PLAN_JSON": ["inputs", "benchmark_release_decision_knowledge_source_action_plan_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_OUTCOME_CORRELATION_JSON": ["inputs", "benchmark_release_decision_knowledge_outcome_correlation_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_OUTCOME_DRIFT_JSON": ["inputs", "benchmark_release_decision_knowledge_outcome_drift_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_COMPETITIVE_SURPASS_INDEX_JSON": ["inputs", "benchmark_release_decision_competitive_surpass_index_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_COMPETITIVE_SURPASS_TREND_JSON": ["inputs", "benchmark_release_decision_competitive_surpass_trend_json"], "WF_INPUT_BENCHMARK_RELEASE_DECISION_COMPETITIVE_SURPASS_ACTION_PLAN_JSON": ["inputs", "benchmark_release_decision_competitive_surpass_action_plan_json"], "STEP_BENCHMARK_SCORECARD_OUTPUT_JSON": ["steps", "benchmark_scorecard", "output_json"], "STEP_BENCHMARK_OPERATIONAL_SUMMARY_OUTPUT_JSON": ["steps", "benchmark_operational_summary", "output_json"], "STEP_BENCHMARK_ARTIFACT_BUNDLE_OUTPUT_JSON": ["steps", "benchmark_artifact_bundle", "output_json"], "STEP_BENCHMARK_COMPANION_SUMMARY_OUTPUT_JSON": ["steps", "benchmark_companion_summary", "output_json"], "STEP_BENCHMARK_ENGINEERING_SIGNALS_OUTPUT_JSON": ["steps", "benchmark_engineering_signals", "output_json"], "STEP_BENCHMARK_REALDATA_SIGNALS_OUTPUT_JSON": ["steps", "benchmark_realdata_signals", "output_json"], "STEP_BENCHMARK_REALDATA_SCORECARD_OUTPUT_JSON": ["steps", "benchmark_realdata_scorecard", "output_json"], "STEP_BENCHMARK_OPERATOR_ADOPTION_OUTPUT_JSON": ["steps", "benchmark_operator_adoption", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_READINESS_OUTPUT_JSON": ["steps", "benchmark_knowledge_readiness", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_DRIFT_OUTPUT_JSON": ["steps", "benchmark_knowledge_drift", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_APPLICATION_OUTPUT_JSON": ["steps", "benchmark_knowledge_application", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_REALDATA_CORRELATION_OUTPUT_JSON": ["steps", "benchmark_knowledge_realdata_correlation", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_DOMAIN_MATRIX_OUTPUT_JSON": ["steps", "benchmark_knowledge_domain_matrix", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_DOMAIN_CAPABILITY_MATRIX_OUTPUT_JSON": ["steps", "benchmark_knowledge_domain_capability_matrix", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_DOMAIN_API_SURFACE_MATRIX_OUTPUT_JSON": ["steps", "benchmark_knowledge_domain_api_surface_matrix", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_DOMAIN_SURFACE_ACTION_PLAN_OUTPUT_JSON": ["steps", "benchmark_knowledge_domain_surface_action_plan", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_DOMAIN_CAPABILITY_DRIFT_OUTPUT_JSON": ["steps", "benchmark_knowledge_domain_capability_drift", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_DOMAIN_CONTROL_PLANE_DRIFT_OUTPUT_JSON": ["steps", "benchmark_knowledge_domain_control_plane_drift", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_DOMAIN_RELEASE_GATE_OUTPUT_JSON": ["steps", "benchmark_knowledge_domain_release_gate", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_REFERENCE_INVENTORY_OUTPUT_JSON": ["steps", "benchmark_knowledge_reference_inventory", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_DOMAIN_ACTION_PLAN_OUTPUT_JSON": ["steps", "benchmark_knowledge_domain_action_plan", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_DOMAIN_CONTROL_PLANE_OUTPUT_JSON": ["steps", "benchmark_knowledge_domain_control_plane", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_SOURCE_COVERAGE_OUTPUT_JSON": ["steps", "benchmark_knowledge_source_coverage", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_SOURCE_ACTION_PLAN_OUTPUT_JSON": ["steps", "benchmark_knowledge_source_action_plan", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_SOURCE_DRIFT_OUTPUT_JSON": ["steps", "benchmark_knowledge_source_drift", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_OUTCOME_CORRELATION_OUTPUT_JSON": ["steps", "benchmark_knowledge_outcome_correlation", "output_json"], "STEP_BENCHMARK_KNOWLEDGE_OUTCOME_DRIFT_OUTPUT_JSON": ["steps", "benchmark_knowledge_outcome_drift", "output_json"], "STEP_BENCHMARK_COMPETITIVE_SURPASS_INDEX_OUTPUT_JSON": ["steps", "benchmark_competitive_surpass_index", "output_json"], "STEP_BENCHMARK_COMPETITIVE_SURPASS_TREND_OUTPUT_JSON": ["steps", "benchmark_competitive_surpass_trend", "output_json"], "STEP_BENCHMARK_COMPETITIVE_SURPASS_ACTION_PLAN_OUTPUT_JSON": ["steps", "benchmark_competitive_surpass_action_plan", "output_json"]}
...
ENABLE_OVERRIDE="${WF_INPUT_BENCHMARK_RELEASE_DECISION_ENABLE:-}"
ENABLE_VALUE="${BENCHMARK_RELEASE_DECISION_ENABLE:-false}"
if [[ -n "$ENABLE_OVERRIDE" ]]; then
  ENABLE_VALUE="$ENABLE_OVERRIDE"
fi
ENABLE_TOKEN="$(echo "$ENABLE_VALUE" | tr '[:upper:]' '[:lower:]' | xargs)"

OUTPUT_JSON="${BENCHMARK_RELEASE_DECISION_OUTPUT_JSON:-reports/history_sequence_eval/benchmark_release_decision.json}"
OUTPUT_MD="${BENCHMARK_RELEASE_DECISION_OUTPUT_MD:-reports/history_sequence_eval/benchmark_release_decision.md}"
mkdir -p "$(dirname "$OUTPUT_JSON")"
mkdir -p "$(dirname "$OUTPUT_MD")"

CMD=(
  python3 scripts/export_benchmark_release_decision.py
  --title "${BENCHMARK_RELEASE_DECISION_TITLE:-Benchmark Release Decision}"
...
add_if_exists --benchmark-scorecard "${WF_INPUT_BENCHMARK_RELEASE_DECISION_SCORECARD_JSON:-}"
add_if_exists --benchmark-operational-summary "${WF_INPUT_BENCHMARK_RELEASE_DECISION_OPERATIONAL_SUMMARY_JSON:-}"
add_if_exists --benchmark-artifact-bundle "${WF_INPUT_BENCHMARK_RELEASE_DECISION_ARTIFACT_BUNDLE_JSON:-}"
add_if_exists --benchmark-companion-summary "${WF_INPUT_BENCHMARK_RELEASE_DECISION_COMPANION_SUMMARY_JSON:-}"
add_if_exists --benchmark-engineering-signals "${WF_INPUT_BENCHMARK_RELEASE_DECISION_ENGINEERING_SIGNALS_JSON:-}"
add_if_exists --benchmark-realdata-signals "${WF_INPUT_BENCHMARK_RELEASE_DECISION_REALDATA_SIGNALS_JSON:-}"
add_if_exists --benchmark-realdata-scorecard "${WF_INPUT_BENCHMARK_RELEASE_DECISION_REALDATA_SCORECARD_JSON:-}"
add_if_exists --benchmark-operator-adoption "${WF_INPUT_BENCHMARK_RELEASE_DECISION_OPERATOR_ADOPTION_JSON:-}"
add_if_exists --benchmark-knowledge-readiness "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_READINESS_JSON:-}"
add_if_exists --benchmark-knowledge-drift "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DRIFT_JSON:-}"
add_if_exists --benchmark-knowledge-application "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_APPLICATION_JSON:-}"
add_if_exists --benchmark-knowledge-realdata-correlation "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_REALDATA_CORRELATION_JSON:-}"
add_if_exists --benchmark-knowledge-domain-matrix "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_MATRIX_JSON:-}"
add_if_exists --benchmark-knowledge-domain-capability-matrix "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_CAPABILITY_MATRIX_JSON:-}"
add_if_exists --benchmark-knowledge-domain-capability-drift "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_CAPABILITY_DRIFT_JSON:-}"
add_if_exists --benchmark-knowledge-domain-control-plane-drift "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_CONTROL_PLANE_DRIFT_JSON:-}"
add_if_exists --benchmark-knowledge-domain-release-gate "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_RELEASE_GATE_JSON:-}"
add_if_exists --benchmark-knowledge-reference-inventory "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_REFERENCE_INVENTORY_JSON:-}"
add_if_exists --benchmark-knowledge-domain-action-plan "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_ACTION_PLAN_JSON:-}"
add_if_exists --benchmark-knowledge-source-coverage "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_SOURCE_COVERAGE_JSON:-}"
add_if_exists --benchmark-knowledge-source-action-plan "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_SOURCE_ACTION_PLAN_JSON:-}"
add_if_exists --benchmark-knowledge-outcome-correlation "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_OUTCOME_CORRELATION_JSON:-}"
add_if_exists --benchmark-knowledge-outcome-drift "${WF_INPUT_BENCHMARK_RELEASE_DECISION_KNOWLEDGE_OUTCOME_DRIFT_JSON:-}"
add_if_exists --benchmark-competitive-surpass-index "${WF_INPUT_BENCHMARK_RELEASE_DECISION_COMPETITIVE_SURPASS_INDEX_JSON:-}"
add_if_exists --benchmark-competitive-surpass-trend "${WF_INPUT_BENCHMARK_RELEASE_DECISION_COMPETITIVE_SURPASS_TREND_JSON:-}"
add_if_exists --benchmark-competitive-surpass-action-plan "${WF_INPUT_BENCHMARK_RELEASE_DECISION_COMPETITIVE_SURPASS_ACTION_PLAN_JSON:-}"
add_if_exists --benchmark-scorecard "${STEP_BENCHMARK_SCORECARD_OUTPUT_JSON:-}"
add_if_exists --benchmark-scorecard "${BENCHMARK_RELEASE_DECISION_SCORECARD_JSON:-}"
add_if_exists --benchmark-operational-summary "${STEP_BENCHMARK_OPERATIONAL_SUMMARY_OUTPUT_JSON:-}"
add_if_exists --benchmark-operational-summary "${BENCHMARK_RELEASE_DECISION_OPERATIONAL_SUMMARY_JSON:-}"
add_if_exists --benchmark-artifact-bundle "${STEP_BENCHMARK_ARTIFACT_BUNDLE_OUTPUT_JSON:-}"
add_if_exists --benchmark-artifact-bundle "${BENCHMARK_RELEASE_DECISION_ARTIFACT_BUNDLE_JSON:-}"
add_if_exists --benchmark-companion-summary "${STEP_BENCHMARK_COMPANION_SUMMARY_OUTPUT_JSON:-}"
add_if_exists --benchmark-companion-summary "${BENCHMARK_RELEASE_DECISION_COMPANION_SUMMARY_JSON:-}"
add_if_exists --benchmark-engineering-signals "${STEP_BENCHMARK_ENGINEERING_SIGNALS_OUTPUT_JSON:-}"
add_if_exists --benchmark-engineering-signals "${BENCHMARK_RELEASE_DECISION_ENGINEERING_SIGNALS_JSON:-}"
add_if_exists --benchmark-realdata-signals "${STEP_BENCHMARK_REALDATA_SIGNALS_OUTPUT_JSON:-}"
add_if_exists --benchmark-realdata-signals "${BENCHMARK_RELEASE_DECISION_REALDATA_SIGNALS_JSON:-}"
add_if_exists --benchmark-realdata-scorecard "${STEP_BENCHMARK_REALDATA_SCORECARD_OUTPUT_JSON:-}"
add_if_exists --benchmark-realdata-scorecard "${BENCHMARK_RELEASE_DECISION_REALDATA_SCORECARD_JSON:-}"
add_if_exists --benchmark-operator-adoption "${STEP_BENCHMARK_OPERATOR_ADOPTION_OUTPUT_JSON:-}"
add_if_exists --benchmark-operator-adoption "${BENCHMARK_RELEASE_DECISION_OPERATOR_ADOPTION_JSON:-}"
add_if_exists --benchmark-knowledge-readiness "${STEP_BENCHMARK_KNOWLEDGE_READINESS_OUTPUT_JSON:-}"
add_if_exists --benchmark-knowledge-readiness "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_READINESS_JSON:-}"
add_if_exists --benchmark-knowledge-drift "${STEP_BENCHMARK_KNOWLEDGE_DRIFT_OUTPUT_JSON:-}"
add_if_exists --benchmark-knowledge-drift "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DRIFT_JSON:-}"
add_if_exists --benchmark-knowledge-application "${STEP_BENCHMARK_KNOWLEDGE_APPLICATION_OUTPUT_JSON:-}"
add_if_exists --benchmark-knowledge-application "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_APPLICATION_JSON:-}"
add_if_exists --benchmark-knowledge-realdata-correlation "${STEP_BENCHMARK_KNOWLEDGE_REALDATA_CORRELATION_OUTPUT_JSON:-}"
add_if_exists --benchmark-knowledge-realdata-correlation "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_REALDATA_CORRELATION_JSON:-}"
add_if_exists --benchmark-knowledge-domain-matrix "${STEP_BENCHMARK_KNOWLEDGE_DOMAIN_MATRIX_OUTPUT_JSON:-}"
add_if_exists --benchmark-knowledge-domain-matrix "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_MATRIX_JSON:-}"
add_if_exists --benchmark-knowledge-domain-capability-matrix "${STEP_BENCHMARK_KNOWLEDGE_DOMAIN_CAPABILITY_MATRIX_OUTPUT_JSON:-}"
add_if_exists --benchmark-knowledge-domain-capability-matrix "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_CAPABILITY_MATRIX_JSON:-}"
...
add_if_exists --benchmark-knowledge-domain-surface-action-plan "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_SURFACE_ACTION_PLAN_JSON:-}"
...
add_if_exists --benchmark-knowledge-domain-control-plane-drift "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_CONTROL_PLANE_DRIFT_JSON:-}"
add_if_exists --benchmark-knowledge-domain-release-gate "${STEP_BENCHMARK_KNOWLEDGE_DOMAIN_RELEASE_GATE_OUTPUT_JSON:-}"
add_if_exists --benchmark-knowledge-domain-release-gate "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_RELEASE_GATE_JSON:-}"
add_if_exists --benchmark-knowledge-reference-inventory "${STEP_BENCHMARK_KNOWLEDGE_REFERENCE_INVENTORY_OUTPUT_JSON:-}"
add_if_exists --benchmark-knowledge-reference-inventory "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_REFERENCE_INVENTORY_JSON:-}"
add_if_exists --benchmark-knowledge-domain-action-plan "${STEP_BENCHMARK_KNOWLEDGE_DOMAIN_ACTION_PLAN_OUTPUT_JSON:-}"
add_if_exists --benchmark-knowledge-domain-action-plan "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_ACTION_PLAN_JSON:-}"
add_if_exists --benchmark-knowledge-domain-control-plane "${STEP_BENCHMARK_KNOWLEDGE_DOMAIN_CONTROL_PLANE_OUTPUT_JSON:-}"
add_if_exists --benchmark-knowledge-domain-control-plane "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_DOMAIN_CONTROL_PLANE_JSON:-}"
add_if_exists --benchmark-knowledge-source-coverage "${STEP_BENCHMARK_KNOWLEDGE_SOURCE_COVERAGE_OUTPUT_JSON:-}"
add_if_exists --benchmark-knowledge-source-coverage "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_SOURCE_COVERAGE_JSON:-}"
add_if_exists --benchmark-knowledge-source-action-plan "${STEP_BENCHMARK_KNOWLEDGE_SOURCE_ACTION_PLAN_OUTPUT_JSON:-}"
add_if_exists --benchmark-knowledge-source-action-plan "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_SOURCE_ACTION_PLAN_JSON:-}"
...
add_if_exists --benchmark-knowledge-outcome-correlation "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_OUTCOME_CORRELATION_JSON:-}"
add_if_exists --benchmark-knowledge-outcome-drift "${STEP_BENCHMARK_KNOWLEDGE_OUTCOME_DRIFT_OUTPUT_JSON:-}"
add_if_exists --benchmark-knowledge-outcome-drift "${BENCHMARK_RELEASE_DECISION_KNOWLEDGE_OUTCOME_DRIFT_JSON:-}"
add_if_exists --benchmark-competitive-surpass-index "${STEP_BENCHMARK_COMPETITIVE_SURPASS_INDEX_OUTPUT_JSON:-}"
add_if_exists --benchmark-competitive-surpass-index "${BENCHMARK_RELEASE_DECISION_COMPETITIVE_SURPASS_INDEX_JSON:-}"
add_if_exists --benchmark-competitive-surpass-trend "${STEP_BENCHMARK_COMPETITIVE_SURPASS_TREND_OUTPUT_JSON:-}"
add_if_exists --benchmark-competitive-surpass-trend "${BENCHMARK_RELEASE_DECISION_COMPETITIVE_SURPASS_TREND_JSON:-}"
add_if_exists --benchmark-competitive-surpass-action-plan "${STEP_BENCHMARK_COMPETITIVE_SURPASS_ACTION_PLAN_OUTPUT_JSON:-}"
add_if_exists --benchmark-competitive-surpass-action-plan "${BENCHMARK_RELEASE_DECISION_COMPETITIVE_SURPASS_ACTION_PLAN_JSON:-}"

if [[ "$ENABLE_TOKEN" != "1" && "$ENABLE_TOKEN" != "true" && "$ENABLE_TOKEN" != "yes" && "$ENABLE_TOKEN" != "on" ]]; then
  if [[ "$INPUT_COUNT" -eq 0 ]]; then
    echo "enabled=false" >> $GITHUB_OUTPUT
    echo "BENCHMARK_RELEASE_DECISION_ENABLE is not true and no inputs found; skip."
    exit 0
  fi
fi
...
if [[ "$INPUT_COUNT" -eq 0 ]]; then
  echo "enabled=false" >> $GITHUB_OUTPUT
  echo "No benchmark release decision inputs found; skip."
  exit 0
fi
...
payload = json.loads(
    Path(os.environ["BENCHMARK_RELEASE_DECISION_OUTPUT_JSON"]).read_text(
        encoding="utf-8"
    )
)
component_statuses = payload.get("component_statuses") or {}
blocking = payload.get("blocking_signals") or []
...
with open(os.environ["GITHUB_OUTPUT"], "a", encoding="utf-8") as f:
    ...
    f.write(
        f"automation_ready={str(payload.get('automation_ready', False)).lower()}\n"
    )
    f.write(
        f"primary_signal_source={payload.get('primary_signal_source', 'none')}\n"
    )
    f.write(f"blocking_signals={compact(blocking)}\n")
    f.write(f"review_signals={compact(review)}\n")
    f.write(f"hybrid_status={component_statuses.get('hybrid', 'unknown')}\n")
    f.write(
        "assistant_status="
        f"{component_statuses.get('assistant_explainability', 'unknown')}\n"
    )
    f.write(
        f"review_queue_status={component_statuses.get('review_queue', 'unknown')}\n"
    )
    f.write(f"ocr_status={component_statuses.get('ocr_review', 'unknown')}\n")
    f.write(f"qdrant_status={component_statuses.get('qdrant_backend', 'unknown')}\n")
    f.write(
        "knowledge_status="
        f"{component_statuses.get('knowledge_readiness', 'unknown')}\n"
    )
    f.write(
        "engineering_status="
        f"{component_statuses.get('engineering_signals', 'unknown')}\n"
    )
    f.write(
        f"realdata_status={component_statuses.get('realdata_signals', 'unknown')}\n"
    )
    f.write(
        "operator_adoption_status="
        f"{component_statuses.get('operator_adoption', 'unknown')}\n"
    )
    ...
    f.write(
        ...
        f"{outcome_drift.get('status', 'unknown')}\n"
    )
    f.write(
        "operator_adoption_knowledge_outcome_drift_summary="
        f"{compact([outcome_drift.get('summary')])}\n"
    )
