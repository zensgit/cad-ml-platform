    ...
    *,
    ...
    return {
        ...
        "benchmark_knowledge_domain_api_surface_matrix": _artifact_row(
            "benchmark_knowledge_domain_api_surface_matrix",
            artifact_paths.get("benchmark_knowledge_domain_api_surface_matrix", ""),
            benchmark_knowledge_domain_api_surface_matrix,
        ),
...
def build_release_runbook(
    *,
    ...
    knowledge_subdomain_surface_matrix_priority_subdomains = list(
        knowledge_subdomain_surface_matrix_component.get("priority_subdomains") or []
    )
    ...
    knowledge_domain_api_surface_matrix_status = (
        str(knowledge_domain_api_surface_matrix_component.get("status") or "unknown").strip()
        or "unknown"
    )
    if knowledge_domain_api_surface_matrix_status not in {
        "",
        "unknown",
    ...
    knowledge_domain_surface_matrix_status = (
        str(knowledge_domain_surface_matrix_component.get("status") or "unknown").strip()
        or "unknown"
    )
    if knowledge_domain_surface_matrix_status not in {
        "",
        "unknown",
    ...
    return {
        ...
        "knowledge_subdomain_surface_matrix_priority_subdomains": (
            knowledge_subdomain_surface_matrix_priority_subdomains
        ),
...
def render_markdown(payload: Dict[str, Any]) -> str:
    ...
    lines.append(
        f"- `status`: `{payload.get('knowledge_domain_api_surface_matrix_status') or 'unknown'}`"
    )
    ...
    lines.append(
        f"- `status`: `{payload.get('knowledge_domain_surface_matrix_status') or 'unknown'}`"
    )
    ...
    lines.append(
        f"- `status`: `{payload.get('knowledge_subdomain_surface_matrix_status') or 'unknown'}`"
    )
