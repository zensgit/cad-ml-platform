#!/usr/bin/env python3
"""Export benchmark knowledge-domain release-readiness matrix signals."""
...
def build_summary(
    *,
    ...
    component = build_knowledge_domain_release_readiness_matrix(
        ...
        benchmark_knowledge_reference_inventory=benchmark_knowledge_reference_inventory,
    ...
    return {
        ...
        "knowledge_domain_release_readiness_matrix": component,
        "recommendations": knowledge_domain_release_readiness_matrix_recommendations(
            component
        ),
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Export benchmark knowledge-domain release-readiness matrix signals."
    )
    parser.add_argument(
        "--title",
        default="Benchmark Knowledge Domain Release Readiness Matrix",
    )
