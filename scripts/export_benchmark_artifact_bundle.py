...
def _knowledge_domain_release_gate(
    ...
    return {
        ...
        "partial_domains": list(gate.get("partial_domains") or []),
...
def _component_statuses(
    ...
    component_rows["knowledge_domain_capability_matrix"] = str(
    ...
    component_rows["knowledge_domain_api_surface_matrix"] = str(
        companion_components.get("knowledge_domain_api_surface_matrix")
        ...
        or (components.get("knowledge_domain_api_surface_matrix") or {}).get("status")
        or "unknown"
    )
    component_rows["knowledge_domain_surface_matrix"] = str(
        companion_components.get("knowledge_domain_surface_matrix")
        or operational_components.get("knowledge_domain_surface_matrix")
        or knowledge_domain_surface_matrix_component.get("status")
        or (components.get("knowledge_domain_surface_matrix") or {}).get("status")
        or "unknown"
    )
    component_rows["knowledge_domain_surface_action_plan"] = str(
        companion_components.get("knowledge_domain_surface_action_plan")
        ...
        or (components.get("knowledge_domain_surface_action_plan") or {}).get("status")
        or "unknown"
    )
    component_rows["knowledge_subdomain_surface_matrix"] = str(
        companion_components.get("knowledge_subdomain_surface_matrix")
        ...
        or (components.get("knowledge_subdomain_surface_matrix") or {}).get("status")
        or "unknown"
    )
    ...
    component_rows["knowledge_domain_action_plan"] = str(
        ...
        or (components.get("knowledge_domain_action_plan") or {}).get("status")
        or "unknown"
    )
    component_rows["knowledge_domain_control_plane"] = str(
        companion_components.get("knowledge_domain_control_plane")
        or operational_components.get("knowledge_domain_control_plane")
        or knowledge_domain_control_plane_component.get("status")
        or (components.get("knowledge_domain_control_plane") or {}).get("status")
        or "unknown"
    )
    component_rows["knowledge_domain_control_plane_drift"] = str(
        ...
        or (
            (components.get("knowledge_domain_control_plane_drift") or {}).get("status")
        )
        or "unknown"
    )
    component_rows["knowledge_source_action_plan"] = str(
        ...
        or (components.get("knowledge_source_action_plan") or {}).get("status")
        or "unknown"
    )
    component_rows["knowledge_source_coverage"] = str(
        ...
        or (components.get("knowledge_source_coverage") or {}).get("status")
        or "unknown"
    )
    component_rows["knowledge_source_drift"] = str(
        ...
        or (components.get("knowledge_source_drift") or {}).get("status")
        or "unknown"
    )
    ...
    component_rows["knowledge_domain_release_gate"] = str(
        companion_components.get("knowledge_domain_release_gate")
        or operational_components.get("knowledge_domain_release_gate")
        or knowledge_domain_release_gate_component.get("status")
        or (components.get("knowledge_domain_release_gate") or {}).get("status")
        or "unknown"
    )
    component_rows["knowledge_domain_release_readiness_action_plan"] = str(
        companion_components.get("knowledge_domain_release_readiness_action_plan")
        or operational_components.get("knowledge_domain_release_readiness_action_plan")
        or (
            benchmark_knowledge_domain_release_readiness_action_plan.get(
                "knowledge_domain_release_readiness_action_plan"
            )
    ...
    component_rows["knowledge_reference_inventory"] = str(
        ...
        or (components.get("knowledge_reference_inventory") or {}).get("status")
        or "unknown"
    )
...
def _pick_summary_items(
    ...
    recommendations = _compact_list(
        ...
        or benchmark_knowledge_domain_api_surface_matrix.get("recommendations")
        ...
        or benchmark_knowledge_domain_control_plane.get("recommendations")
        or benchmark_knowledge_domain_release_gate.get("recommendations")
        or benchmark_knowledge_domain_release_readiness_action_plan.get("recommendations")
        or benchmark_knowledge_reference_inventory.get("recommendations")
...
def build_bundle(
    *,
    ...
    knowledge_domain_api_surface_matrix_recommendations = _compact_list(
        benchmark_knowledge_domain_api_surface_matrix.get("recommendations") or []
    )
    knowledge_domain_surface_matrix_recommendations = _compact_list(
        benchmark_knowledge_domain_surface_matrix.get("recommendations") or []
    )
    knowledge_domain_surface_action_plan_recommendations = _compact_list(
        benchmark_knowledge_domain_surface_action_plan.get("recommendations") or []
    )
    knowledge_subdomain_surface_matrix_recommendations = _compact_list(
    ...
    knowledge_domain_control_plane_recommendations = _compact_list(
        benchmark_knowledge_domain_control_plane.get("recommendations") or []
    )
    knowledge_domain_control_plane_drift_recommendations = _compact_list(
        benchmark_knowledge_domain_control_plane_drift.get("recommendations") or []
    )
    knowledge_domain_release_gate_recommendations = _compact_list(
        benchmark_knowledge_domain_release_gate.get("recommendations") or []
    )
    knowledge_domain_release_readiness_action_plan_recommendations = _compact_list(
        benchmark_knowledge_domain_release_readiness_action_plan.get(
            "recommendations"
        )
        or []
    )
    knowledge_reference_inventory_recommendations = _compact_list(
        benchmark_knowledge_reference_inventory.get("recommendations") or []
    )
    knowledge_source_action_plan_recommendations = _compact_list(
        benchmark_knowledge_source_action_plan.get("recommendations") or []
    )
    knowledge_source_coverage_recommendations = _compact_list(
        benchmark_knowledge_source_coverage.get("recommendations") or []
    )
    knowledge_source_drift_recommendations = _compact_list(
    ...
    artifact_rows = {
        ...
        "benchmark_knowledge_domain_capability_matrix": _artifact_row(
            name="benchmark_knowledge_domain_capability_matrix",
            path_text=artifact_paths.get(
                "benchmark_knowledge_domain_capability_matrix",
                "",
            ),
        ...
        "benchmark_knowledge_domain_api_surface_matrix": _artifact_row(
            name="benchmark_knowledge_domain_api_surface_matrix",
            path_text=artifact_paths.get(
                "benchmark_knowledge_domain_api_surface_matrix",
                "",
            ),
            payload=benchmark_knowledge_domain_api_surface_matrix,
        ),
        "benchmark_knowledge_domain_surface_matrix": _artifact_row(
            name="benchmark_knowledge_domain_surface_matrix",
            path_text=artifact_paths.get("benchmark_knowledge_domain_surface_matrix", ""),
            payload=benchmark_knowledge_domain_surface_matrix,
        ),
        "benchmark_knowledge_domain_surface_action_plan": _artifact_row(
            name="benchmark_knowledge_domain_surface_action_plan",
            path_text=artifact_paths.get(
                "benchmark_knowledge_domain_surface_action_plan", ""
            ),
            payload=benchmark_knowledge_domain_surface_action_plan,
        ),
        "benchmark_knowledge_subdomain_surface_matrix": _artifact_row(
            name="benchmark_knowledge_subdomain_surface_matrix",
            path_text=artifact_paths.get(
                "benchmark_knowledge_subdomain_surface_matrix", ""
            ),
            payload=benchmark_knowledge_subdomain_surface_matrix,
        ),
        ...
        "benchmark_knowledge_domain_action_plan": _artifact_row(
            ...
            payload=benchmark_knowledge_domain_action_plan,
        ),
        "benchmark_knowledge_domain_control_plane": _artifact_row(
            name="benchmark_knowledge_domain_control_plane",
            path_text=artifact_paths.get(
                "benchmark_knowledge_domain_control_plane",
                "",
            ),
            payload=benchmark_knowledge_domain_control_plane,
        ),
        "benchmark_knowledge_domain_control_plane_drift": _artifact_row(
            name="benchmark_knowledge_domain_control_plane_drift",
            path_text=artifact_paths.get(
                "benchmark_knowledge_domain_control_plane_drift",
                "",
            ),
        ...
        "benchmark_knowledge_domain_release_gate": _artifact_row(
            name="benchmark_knowledge_domain_release_gate",
            path_text=artifact_paths.get("benchmark_knowledge_domain_release_gate", ""),
            payload=benchmark_knowledge_domain_release_gate,
        ),
        "benchmark_knowledge_domain_release_readiness_action_plan": _artifact_row(
            name="benchmark_knowledge_domain_release_readiness_action_plan",
            path_text=artifact_paths.get(
                "benchmark_knowledge_domain_release_readiness_action_plan",
                "",
            ),
            payload=benchmark_knowledge_domain_release_readiness_action_plan,
        ),
        ...
        "benchmark_knowledge_reference_inventory": _artifact_row(
            name="benchmark_knowledge_reference_inventory",
            path_text=artifact_paths.get("benchmark_knowledge_reference_inventory", ""),
            payload=benchmark_knowledge_reference_inventory,
        ),
        "benchmark_knowledge_source_action_plan": _artifact_row(
            ...
            payload=benchmark_knowledge_source_action_plan,
        ),
        "benchmark_knowledge_source_coverage": _artifact_row(
            name="benchmark_knowledge_source_coverage",
            path_text=artifact_paths.get(
                "benchmark_knowledge_source_coverage",
                "",
            ),
            payload=benchmark_knowledge_source_coverage,
        ),
        "benchmark_knowledge_source_drift": _artifact_row(
            name="benchmark_knowledge_source_drift",
            path_text=artifact_paths.get("benchmark_knowledge_source_drift", ""),
            payload=benchmark_knowledge_source_drift,
        ),
    ...
    return {
        ...
        "knowledge_domain_api_surface_matrix_status": (
            knowledge_domain_api_surface_matrix_component.get("status") or "unknown"
        ),
        "knowledge_domain_api_surface_matrix": (
            knowledge_domain_api_surface_matrix_component
        ),
        "knowledge_domain_api_surface_matrix_domains": (
            knowledge_domain_api_surface_matrix_component.get("domains") or {}
        ),
        "knowledge_domain_api_surface_matrix_priority_domains": list(
            knowledge_domain_api_surface_matrix_component.get("priority_domains") or []
        ),
        "knowledge_domain_api_surface_matrix_public_api_gap_domains": list(
            knowledge_domain_api_surface_matrix_component.get(
        ...
        "knowledge_domain_surface_matrix_status": (
            knowledge_domain_surface_matrix_component.get("status") or "unknown"
        ),
        "knowledge_domain_surface_matrix": knowledge_domain_surface_matrix_component,
        "knowledge_domain_surface_matrix_domains": (
            knowledge_domain_surface_matrix_component.get("domains") or {}
        ),
        "knowledge_domain_surface_matrix_priority_domains": list(
            knowledge_domain_surface_matrix_component.get("priority_domains") or []
        ),
        "knowledge_domain_surface_matrix_public_surface_gap_domains": list(
            knowledge_domain_surface_matrix_component.get(
                "public_surface_gap_domains"
            )
            or []
        ),
        ...
        "knowledge_domain_surface_action_plan_priority_domains": list(
            knowledge_domain_surface_action_plan_component.get("priority_domains")
            or []
        ),
        ...
        "knowledge_subdomain_surface_matrix_status": (
            knowledge_subdomain_surface_matrix_component.get("status") or "unknown"
        ),
        "knowledge_subdomain_surface_matrix": (
            knowledge_subdomain_surface_matrix_component
        ),
        "knowledge_subdomain_surface_matrix_subdomains": (
            knowledge_subdomain_surface_matrix_component.get("subdomains") or {}
        ),
        "knowledge_subdomain_surface_matrix_priority_subdomains": list(
            knowledge_subdomain_surface_matrix_component.get("priority_subdomains")
            or []
        ),
        "knowledge_subdomain_surface_matrix_public_api_gap_subdomains": list(
            knowledge_subdomain_surface_matrix_component.get(
        ...
        "knowledge_domain_control_plane_status": (
            knowledge_domain_control_plane_component.get("status") or "unknown"
        ),
        ...
        "knowledge_domain_control_plane_drift_new_release_blockers": list(
            knowledge_domain_control_plane_drift_component.get("new_release_blockers")
            or []
        ),
        ...
        "knowledge_domain_release_gate_priority_domains": list(
            knowledge_domain_release_gate.get("priority_domains") or []
        ),
        "knowledge_domain_release_gate_recommendations": (
            knowledge_domain_release_gate_recommendations
        ),
        "knowledge_domain_release_readiness_action_plan_status": (
            knowledge_domain_release_readiness_action_plan.get("status") or "unknown"
        ),
        "knowledge_domain_release_readiness_action_plan": (
            knowledge_domain_release_readiness_action_plan
        ),
        ...
        "knowledge_source_drift_status": (
            knowledge_source_drift_component.get("status") or "unknown"
        ),
...
def render_markdown(payload: Dict[str, Any]) -> str:
    ...
    lines = [
        ...
        f"`{payload.get('knowledge_source_action_plan_status') or 'unknown'}`",
    ...
    if surface_domains:
        for name, row in surface_domains.items():
            lines.append(
                ...
                f"status=`{row.get('status')}` "
                f"reference_items=`{row.get('reference_item_count')}` "
                f"subcapabilities=`{row.get('subcapability_count')}`"
            )
    else:
        lines.append("- none")
    ...
    if surface_action_plan_actions:
        for item in surface_action_plan_actions[:5]:
            lines.append(
                "- "
                f"`{item.get('domain')}` "
    ...
    subdomain_rows = payload.get("knowledge_subdomain_surface_matrix_subdomains") or {}
    if subdomain_rows:
        for name, row in list(subdomain_rows.items())[:6]:
            lines.append(
                "- "
                f"`{name}` "
                f"status=`{row.get('status')}` "
    ...
    lines.append(
        ...
        + (
            ", ".join(
                str(item)
                for item in (
                    payload.get("knowledge_source_drift_source_group_regressions") or []
                )
            )
            or "none"
        )
    ...
    lines.append(
        ...
        + (
            ", ".join(
                str(item)
                for item in (
                    payload.get("knowledge_source_drift_source_group_improvements") or []
                )
            )
            or "none"
        )
    ...
    lines.append(
        ...
        + (
            ", ".join(
                str(item)
                for item in (
                    payload.get("knowledge_source_drift_resolved_priority_domains") or []
                )
            )
            or "none"
        )
    ...
    lines.append(
        ...
        + (
            ", ".join(
                str(item)
                for item in (
                    payload.get("knowledge_source_drift_new_priority_domains") or []
                )
            )
            or "none"
        )
    ...
    outcome_recommendations = outcome_drift.get("recommendations") or []
    if outcome_recommendations:
        for item in outcome_recommendations:
            lines.append(f"- recommendation: {item}")
    else:
        lines.append("- recommendation: none")
    ...
    lines.append(
        "- `blocking_reasons`: "
        + (
            ", ".join(str(item) for item in (knowledge_gate.get("blocking_reasons") or []))
            or "none"
        )
    )
    lines.append(
        "- `releasable_domains`: "
        + (
            ", ".join(str(item) for item in (knowledge_gate.get("releasable_domains") or []))
            or "none"
        )
    )
