#!/usr/bin/env python3
"""Export benchmark knowledge domain control-plane drift."""
...
def build_summary(
    *,
    ...
    return {
        ...
        "knowledge_domain_control_plane_drift": component,
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Export benchmark knowledge domain control-plane drift summary."
    )
    parser.add_argument(
        "--title",
        default="Benchmark Knowledge Domain Control Plane Drift",
    )
    ...
    if args.output_md:
        _write_output(
            args.output_md,
            render_knowledge_domain_control_plane_drift_markdown(payload, args.title),
        )
    print(rendered)
