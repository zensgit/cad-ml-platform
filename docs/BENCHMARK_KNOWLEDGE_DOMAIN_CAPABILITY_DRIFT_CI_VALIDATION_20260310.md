# Benchmark Knowledge Domain Capability Drift CI Validation

## Scope

- Wired `benchmark_knowledge_domain_capability_drift` into `evaluation-report.yml`.
- Added workflow-dispatch inputs, env defaults, build step, artifact upload, and job summary rows.
- Passed drift JSON into:
