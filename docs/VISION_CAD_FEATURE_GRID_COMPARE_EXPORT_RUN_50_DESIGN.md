# Vision CAD Feature Grid Compare Export Run 50 Design

## Overview
Re-run the grid baseline/compare/export workflow with a larger sample size to
observe delta stability across more images.
...
python3 scripts/vision_cad_feature_benchmark.py \
  ...
  --output-json reports/vision_cad_feature_grid_baseline_20260106_50.json
...
python3 scripts/vision_cad_feature_benchmark.py \
  ...
  --output-json reports/vision_cad_feature_grid_compare_20260106_50.json \
  --compare-json reports/vision_cad_feature_grid_baseline_20260106_50.json \
  --output-compare-csv reports/vision_cad_feature_grid_compare_summary_20260106_50.csv

# Export top sample deltas
python3 scripts/vision_cad_feature_compare_export.py \
  --input-json reports/vision_cad_feature_grid_compare_20260106_50.json \
  --output-json reports/vision_cad_feature_grid_compare_top_20260106_50.json \
  --output-csv reports/vision_cad_feature_grid_compare_top_20260106_50.csv \
  --top-samples 5
```
