# DEV_METRICS_DELIVERY_CHECKLIST_20260106

## Scope
Delivery checklist for metrics-related changes, design docs, validation reports, and key test runs.
...
## Key Commands
- `.venv/bin/python -m pytest tests/test_metrics_contract.py -v`
- `.venv/bin/python -m pytest tests/unit/test_cache_tuning.py tests/unit/test_model_opcode_modes.py tests/unit/test_v4_feature_performance.py -v`
