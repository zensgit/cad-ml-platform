...
def test_vector_distribution_endpoint():
    register_vector("dist_a", [0.1] * 7, meta={"material": "steel", "complexity": "low", "format": "dxf"})
    register_vector("dist_b", [0.2] * 7, meta={"material": "steel", "complexity": "medium", "format": "stl"})
    register_vector("dist_c", [0.3] * 7, meta={"material": "aluminum", "complexity": "high", "format": "step"})
