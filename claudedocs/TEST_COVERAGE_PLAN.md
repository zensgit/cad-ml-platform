...
| 模块 | 覆盖率 | 说明 |
|------|--------|------|
| `src/ml/part_classifier.py` | ~65% | V16优化后需更新测试 |
| `src/ml/hybrid_classifier.py` | ~50% | 核心分类器 |
...
| 模块 | 覆盖率 | 说明 |
|------|--------|------|
| `src/utils/dxf_features.py` | 71% | 特征提取 |
| `src/utils/logging.py` | 70% | 日志工具 |
| `src/utils/safe_eval.py` | 64% | 安全评估 |
