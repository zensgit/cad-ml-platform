"""
CAD Assistant API - OpenAPI Schema Definition.

This module provides the OpenAPI/Swagger documentation for the CAD Assistant API.
"""
...
- Enterprise: 500 请求/分钟
    ...
    "tags": [
        {"name": "assistant", "description": "智能助手 API"},
        {"name": "conversation", "description": "对话管理 API"},
        {"name": "knowledge", "description": "知识库 API"},
        {"name": "streaming", "description": "流式响应 API"},
        {"name": "admin", "description": "管理 API"},
    ...
    "components": {
        ...
        "schemas": {
            ...
            "Source": {
                "type": "object",
                "properties": {
                    "type": {"type": "string", "example": "material_database"},
                    "content": {"type": "string"},
                    "relevance": {"type": "number", "example": 0.95},
                },
            },
            "ConversationResponse": {
                "type": "object",
                "properties": {
                    "id": {"type": "string", "example": "conv-abc123"},
            ...
            "KnowledgeSearchRequest": {
                ...
                "properties": {
                    ...
                    "category": {
                        "type": "string",
                        "enum": ["materials", "welding", "gdt", "surface_treatment"],
                    },
...
def get_openapi_schema() -> Dict[str, Any]:
    """Get the OpenAPI schema for the CAD Assistant API."""
